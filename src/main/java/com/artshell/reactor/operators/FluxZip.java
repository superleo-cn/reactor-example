...
public class FluxZip {
    /**
     * @see Flux#zip(Publisher, Publisher, Publisher)
     * @see Flux#zip(Publisher, Publisher, Publisher, Publisher)
     * @see Flux#zip(Publisher, Publisher, Publisher, Publisher, Publisher)
     * @see Flux#zip(Publisher, Publisher, Publisher, Publisher, Publisher, Publisher)
     * @see Flux#zip(Function, Publisher[])
     * @see Flux#zip(Function, int, Publisher[])
     */
    ...
    /**
     * @see Flux#zip(Iterable, Function)
     * @see Flux#zip(Iterable, int, Function)
     */
    ...
    /**
     * @see Flux#zip(Publisher, Function)
     */
     ...
     * @see Flux#zip(Publisher, Publisher, BiFunction)
     */
